...
export default class App extends Component {
  state = {
    comments: [
      {id: 1, author: 'Natalia Agzamova', text: 'Hello world', time: '9:00', date: '16.07.2020'},
      {id: 2, author: 'Vlad Ivanov', text: 'Hello there', time: '9:00', date: '18.07.2020'},
      {id: 3, author: 'Maksim Petrov', text: 'Hello people', time: '10:00', date: '26.07.2020'},
    ],
    author: '',
    text: '',
    time: '',
